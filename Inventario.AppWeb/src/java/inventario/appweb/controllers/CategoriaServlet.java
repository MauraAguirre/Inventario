    ...
    private void doPostRequestCreate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {
                ...
                Utilidad.enviarError("No se logró agregar un nuevo registro de categoria", request, response);
            }
        } catch (Exception ex) {
            Utilidad.enviarError(ex.getMessage(), request, response);
        }
    ...
    private void doPostRequestEdit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {
                ...
                Utilidad.enviarError("No se logró actualizar el registro de la categoria", request, response);
            }
        } catch (Exception ex) {
    ...
    private void doPostRequestDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (result != 0) {
                ...
                Utilidad.enviarError("No se logró eliminar el registro de la categoria", request, response);
            }
        } catch (Exception ex) {
            Utilidad.enviarError(ex.getMessage(), request, response);
        }
